    ...
    submit = async () => {
        ...
        try {
            ...
            if (response.Status) {
                ...
                this.props.router.navigate({pathname:"/auth/resetPasswordScreen",params:{email}});
            } 
        } catch (error) {
            ShowModal({
                title: 'Failure',
                ...
                <KeyboardAvoidingView style={css.container}>
                        <View style={{marginTop:'17%'}}>
                            <View style={{alignItems:'center',marginBottom:35}}>
                                <Text style={{fontSize:27,color:'#003366',fontWeight:'800',textAlign:'center'}}>Forget Password</Text>
                            </View>
